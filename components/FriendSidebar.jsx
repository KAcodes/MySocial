...
const FriendSidebar = () => {
  ...
  return (
    <div className="bg-slate-100 w-1/5 ml-3 p-1 hidden md:block">
      ...
      <div className='flex flex-col'>
        {profileArray.map((user, index) => {
          return (
            <button key={index} className="flex flex-row p-2 my-1 mx-1 space-x-4 place-items-center rounded hover:bg-slate-300 hover:opacity-95 ">
